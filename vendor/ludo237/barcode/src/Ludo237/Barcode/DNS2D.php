...
namespace Ludo237\Barcode;

use Ludo237\Barcode\QRcode;
use Ludo237\Barcode\Datamatrix;
use Ludo237\Barcode\PDF417;
...
class DNS2D {
     ...
     * @public
     */
    public function getBarcodePNGPath($code, $type, $file_name,  $w = 3, $h = 3, $color = array(0, 0, 0)) {
        if (!$this->store_path) {
            $this->setStorPath(\Config::get("barcode::store_path"));
        }
        //set barcode code and type
