...
--
-- Host: localhost
-- Generation Time: Dec 04, 2014 at 09:18 AM
...
--
-- Database: `riset_operational`
--
CREATE DATABASE `riset_operational` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
--
-- Table structure for table `srv_general`
--
...
--
-- Dumping data for table `srv_general`
--
...
--
-- Table structure for table `srv_pendirian_bangunan`
--
...
--
-- Table structure for table `srv_praktek_dokter_umum`
--
...
--
-- Dumping data for table `srv_praktek_dokter_umum`
--
...
--
-- Table structure for table `srv_warnet`
--
...
--
-- Dumping data for table `srv_warnet`
--
